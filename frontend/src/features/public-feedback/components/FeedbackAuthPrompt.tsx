...
export function FeedbackAuthPrompt() {
  return (
    <Card className="max-w-lg mx-auto">
      <CardContent className="pt-8 pb-8 text-center space-y-6">
        ...
        <div className="space-y-2">
          <h3 className="text-xl font-semibold">Connectez-vous pour laisser un avis</h3>
          <p className="text-muted-foreground">
            Vous devez avoir un compte pour donner votre avis sur SantéProx.
          </p>
        </div>
        <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
          <Link
            href="/inscription?returnTo=/feedback"
          ...
          <Link
            href="/connexion?returnTo=/feedback"
